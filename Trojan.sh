...
if [ ! "$wName" ]; then
	echo -e "\033[102;91m已安装wget\033[0m"
else
...
if [ ! "$zName" ]; then
	echo -e "\033[102;91m已安装zip\033[0m"
else
...
if [ ! "$qName" ]; then
	echo -e "\033[102;91m已安装qrencode\033[0m"
else
...
if [ ! "$sName" ]; then
	echo -e "\033[102;91m已安装socat\033[0m"
else
...
if [ ! "$cName" ]; then
	...
	echo -e "\033[102;91m已下载配置文件\033[0m"
fi
